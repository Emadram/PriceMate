...
const AddPriceModal = ({ isOpen, onClose, product }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (result) {
            ...
            setStatus('error');
            setErrorMessage('Failed to add price. Please try again.');
        }
    };
            ...
            <div className="relative bg-white dark:bg-gray-900 w-full max-w-lg rounded-[2.5rem] shadow-2xl overflow-hidden animate-in fade-in zoom-in slide-in-from-bottom-5 duration-300">
                <div className="p-8 pb-safe-nav">
                    ...
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            <h3 className="text-2xl font-black text-gray-900 dark:text-white tracking-tight">Add Price</h3>
                    ...
                    {status === 'success' ? (
                        <div className="py-12 flex flex-col items-center justify-center text-center space-y-4">
                            ...
                            <h4 className="text-xl font-bold text-gray-900 dark:text-white">Price Added Successfully!</h4>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-2">Supermarket</label>
                                <select 
                            ...
                            {/* Price Input */}
                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-2">Price (TRY)</label>
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-2">Stock Availability</label>
                                <div className="grid grid-cols-3 gap-3">
                                    {[
                                        { id: 'high', label: 'In Stock', color: 'bg-green-500' },
                                        { id: 'low', label: 'Low Stock', color: 'bg-amber-500' },
                                        { id: 'none', label: 'Out of Stock', color: 'bg-red-500' }
                                    ].map((option) => (
                                        <button
                                            key={option.id}
                                            type="button"
