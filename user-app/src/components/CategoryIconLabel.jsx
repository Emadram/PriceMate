...
const CategoryIconLabel = ({ categoryId, fallbackName = 'Other', className = '' }) => {
    ...
    return (
        ...
        >
            <span className="inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-gray-50 text-lg text-blue-600 dark:bg-gray-800 dark:text-blue-400">
                {iconEl}
            </span>
